...
Como podemos ver, a ferramenta TweeProfiles permite uma grande variedade de combinações que produzem resultados que que podem variar no número e posição geográfica dos \textit{clusters} consoante a influência e peso das das dimensões em consideração.
